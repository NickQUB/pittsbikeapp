...
machineLearningModel = joblib.load((filename))


# In[3]:


#Construct URL to fetch JSON Data
...
fig1 = px.bar( x=dateTimeList, y=predictions)
fig1.update_layout(title={
        'text': "Predicted Usage of Pittsburgh Bike Scheme in next 5 Days",
        'y':0.95,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'},
...
#                 html.H1(
#                     children="Pittsburgh", className="header-title"
#                 ),
#                 html.P(
#                     children="Bike Scheme Usage Forecast For Coming 5 Days",
...
# app.title = "Pittsburgh Healthy Ride Bike Network Analysis!" ######################################################################
